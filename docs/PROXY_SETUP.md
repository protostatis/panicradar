...
The host and containers use direct EC2 egress. The integration refreshes its
in-memory Reddit cookies after an unusable Reddit response and does not
intentionally write them to GitHub secrets, the database, logs, or
